...
function App() {
  ...
  const [selectedTab, setSelectedTab] = useState<'all' | 'valid' | 'filtered' | 'dashboard' | 'testlist'>('dashboard');
        ...
        <div className="flex px-6">
          ...
          {isHeaderHidden && (
            <button
              ...
              className="ml-auto px-3 py-2 text-sm font-medium text-[#969696] hover:text-[#cccccc] transition-all flex items-center space-x-2"
              title="Show header"
            >
      ...
      <div className="flex-1 overflow-hidden">
        {selectedTab === 'dashboard' ? (
          ...
          <div className="h-full flex flex-col">
            ...
            {/* Clean Alerts List */}
            <div className="flex-1 overflow-y-auto bg-[#1e1e1e] alerts-container">
              {getFilteredAlerts().length === 0 && !loading ? (
                  ...
                  {getFilteredAlerts().map((alert, index) => (
                    ...
                    >
                      <div className="grid grid-cols-12 gap-4 items-center text-sm">
                        ...
                        {/* Price - Prioritize ChartsWatcher price */}
                        <div className="col-span-1">
                ...
                {selectedStockInfo.error ? (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {/* Trading Conditions */}
                      <div className="bg-[#252526] rounded-lg border border-[#3e3e42] p-4">
                        <h3 className="text-sm font-semibold text-[#cccccc] mb-3 uppercase tracking-wide">Condiciones</h3>
                        <div className="space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-[#969696] text-sm">Score</span>
                            <span className={`font-mono text-sm ${selectedStockInfo.evaluation?.allConditionsMet ? 'text-[#4ec9b0]' : 'text-[#f44747]'}`}>
                              {selectedStockInfo.evaluation?.score || 'N/A'}
                            </span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-[#969696] text-sm">Estado</span>
                            <span className={`text-xs px-2 py-1 rounded ${selectedStockInfo.evaluation?.allConditionsMet ? 'bg-[#4ec9b0]/20 text-[#4ec9b0]' : 'bg-[#f44747]/20 text-[#f44747]'}`}>
                              {selectedStockInfo.evaluation?.allConditionsMet ? 'VÁLIDO' : 'FILTRADO'}
                            </span>
                          </div>
                        </div>
                      </div>
